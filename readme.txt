...
4. Install **MongoDB**, and for more convenient use **MongoDBCompass**

5. In MongoDBCompass, import the database I provided in the file **superheroes.superheros.json**
